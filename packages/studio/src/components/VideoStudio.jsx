...
export default function VideoStudio({
  ...
  return (
    ...
    >
      ...
      {/* ── BOTTOM PROMPT BAR ── */}
      <div className="absolute bottom-4 left-4 right-4 md:left-0 md:right-0 md:mx-auto md:max-w-[95%] lg:max-w-4xl z-40 animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
